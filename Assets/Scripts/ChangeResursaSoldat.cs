...
public class ChangeResursaSoldat : MonoBehaviour
{
    public TotalZar total;
    public GameObject changeZar1, changeZar2, changeZar3, changeZar4, changeZar5, cantChange, rollBtn, soldatView;
    public int tipResursa;
    public int[] used;
    public EndTurn turn;
    ...
    public void DiceChangeSoldat()
    {
        if (total.totalZar % tipResursa == 0)
        {
            ...
            total.tradeResource = tipResursa;
            used[(turn.turnCount - 1) % player.noPlayers] = 1;
